...
export default function AddComponentSourcing() {
  ...
  const [formData, setFormData] = useState<ServiceData>({
    ...
    description: "",
    category: "",
    service_type: "component_sourcing",
    base_price: 0,
    status: true,
    config: {},
  });
    ...
    <>
      <div className="mb-6 flex items-center justify-between">
        <h1 className="text-body-1xlg font-bold text-dark dark:text-white">
          ADD COMPONENT SOURCING SERVICE
        </h1>
        <button
      ...
      <ServiceCards currentService="component_sourcing" />
