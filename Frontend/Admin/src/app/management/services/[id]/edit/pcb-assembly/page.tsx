...
interface ServiceConfig {
  ...
  assembly_type?: ConfigOption;
  rework_allowed?: ConfigOption;
  testing_type?: ConfigOption;
}
...
const FIELD_LABELS: Record<string, string> = {
  ...
  rework_allowed: "Rework Allowed",
  testing_type: "Testing Type",
};

const FIELD_PLACEHOLDERS: Record<string, string> = {
  components: "e.g., 25,100,230",
  lead_time_days: "e.g., 3,5,7",
  assembly_type: "e.g., SMT,DIP,Mixed",
  rework_allowed: "true,false",
  testing_type: "e.g., AOI,ICT,Functional",
};

const REQUIRED_FIELDS = ["components", "lead_time_days", "assembly_type", "rework_allowed", "testing_type"];

export default function EditPCBAssembly() {
    ...
    if (!input.trim()) {
      setFormData((prev) => ({
        ...
        config: {
          ...prev.config,
          [fieldName]: {
            type: fieldName === "rework_allowed" ? "boolean" : "select",
            options: [],
            multiplier: {},
          },
        },
